...
def main():
    ...
    st.write("Upload an image of a basketball court to detect and draw the court lines using a U-Net model.")
    
    # Sidebar
    st.sidebar.header("Model Configuration")
    model_path = st.sidebar.text_input("Model Path", value="D:\Personal Projects\Basketball Project\YOLO Results\U-net best model\\best_model_epoch89.pth")
    
    # File upload
    uploaded_file = st.file_uploader("Choose a basketball court image", type=["jpg", "jpeg", "png"])
